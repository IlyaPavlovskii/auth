...
internal class AuthByEmailViewModel(
    reducer: ComplexReducer<State, Message, Effect>,
    effectHandler: CoroutineEffectHandler<Effect, Message>,
    viewStateConverter: ViewStateConverter<State, AuthByEmailViewState>,
) : ViewModel() {
    private val _viewState = MutableStateFlow(AuthByEmailViewState.DEFAULT)
    val viewState: StateFlow<AuthByEmailViewState> = _viewState
